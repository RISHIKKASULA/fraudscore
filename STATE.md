...
- [ ] 2. Data fetch with integrity checks + synthetic fixture generator
- [ ] 3. Feature pipeline with cyclical phase encoding (+ unit tests)
- [ ] 4. Baseline logistic regression
- [ ] 5. Gradient boosting with time-series CV selection
- [ ] 6. Probability calibration with method selection (+ tests)
- [ ] 7. Expected-cost decision rule and threshold baseline (+ toy-case tests)
- [ ] 8. Bootstrap confidence intervals for cost metrics
- [ ] 9. Evaluation report with cost curves and CIs
- [ ] 10. Serve expected-cost decisions over FastAPI (+ contract tests)
- [ ] 11. Batch scoring to DuckDB
- [ ] 12. CI workflow + Dockerfile
- [ ] 13. README with measured results
- [ ] 14. v1.0.0 release
